    ...
    int main() {
        ...
        for (const auto& [position, defaultRole] : defaultLaneRoles) {
            ...
            std::cout << "\033[1;92m" << position << " lane \033[0m - Pick a role \033[1;92m (Tank, Mage, Marksman, Assassin, Fighter, Support) [default: " << defaultRole << "]: \033[0m \n";
            ...
            if (redPick) {
                ...
                setColor(12); 
                std::cout << "Red Team picked: [" << position << "]\n";
                redPick->displayInfo();
                setColor(7); // Reset
        ...
        std::cout << std::setw(47) << std::left << "\033[1;34m BLUE TEAM \033[0m" << " |" << "\033[1;31m RED TEAM \033[0m" << std::setfill('=') << std::setw(33)<<std::right<<'\n';
        ...
        for (size_t i = 0; i < maxLines; ++i) {
            ...
            std::cout << "\033[1;31m"<< std::setw(40) << std::left  <<blueEntry << "\033[0m | " << "\033[1;31m" << redEntry << "\033[0m\n";
        }
